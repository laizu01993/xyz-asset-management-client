...
const Navbar = () => {
    ...
    return (
        <div className="navbar sticky top-0 z-50 bg-black/30 backdrop-blur-md px-4">
            {/* ================= LEFT: LOGO ================= */}
            <div className="navbar-start">
                {showXYZ ? (
                    <div className="btn btn-ghost text-4xl text-blue-900 font-bold">
                    ...
                    <div className="tooltip tooltip-bottom" data-tip={userData?.companyName}>
                        <img
                            src={companyLogo}
                            alt="Company Logo"
                            className="w-10 h-10 rounded-full object-cover cursor-pointer"
                ...
                >
                    ...
                    <ul
                        className={`
              absolute left-0 mt-3 w-52 bg-base-100 rounded-box shadow z-50
